...
module convolution_engine #(
    ...
    input conv_comp,
    input hold,
    input wire [1023:0] mem_data_inn,         
    input wire [1023:0] eng_shift,         // 1D array for eng_shift input for each PE
    (* keep = "true" *)output wire [1023:0] ENG_shift_out, //ENgine shift from outfmap,
